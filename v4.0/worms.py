...
class Main(GLCanvas):
    ...
    def reset(self, event):
        ...
        print "Count:", count, " Size", size, " Color Format",
        if colorFormat == RGB: print "RGB",
        else: print "HSV",
        print " Colors:",
        if colors == 0: print "Uniform",
        elif colors == 1: print "Altered",
        else: print "Random",
        print " Color Step:", colorStep, " Worm Step:", wormStep,
        print " Shape:",
        if shape == RANDOM: print "Random",
        elif shape == POINT: print "Point",
        elif shape == SQUARE: print "Square",
        elif shape == LINE: print "Line",
        elif shape == TRIANGLE: print "Triangle",
        elif shape == CIRCLE: print "Circle",
        elif shape == RCIRCLE: print "Random Circle",
        elif shape == RSQUARE: print "Random Square",
        print
